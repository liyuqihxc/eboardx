...
F 1 "R_POT" H 1756 6770 50  0000 R CNN
...
U 1 1 5E8030B1
P 4825 6225
F 0 "DS1" H 4825 7206 50  0000 C CNN
F 1 "LCD_1602" H 4825 7115 50  0000 C CNN
F 2 "Display:HY1602E" H 4825 5325 50  0001 C CIN
F 3 "http://www.icbank.com/data/ICBShop/board/HY1602E.pdf" H 5025 6325 50  0001 C CNN
F 4 "LCM1602K-NSW-BBW" H 4825 6225 50  0001 C CNN "PartNo"
	1    4825 6225
	1    0    0    -1  
$EndComp
...
F 1 "Q_NMOS_DGS" H 9829 5380 50  0000 L CNN
F 2 "" H 9825 5525 50  0001 C CNN
...
F 1 "Buzzer" H 9977 4763 50  0000 L CNN
F 2 "" V 9800 4925 50  0001 C CNN
...
F 4 "1N4148" H 9300 4825 50  0001 C CNN "PartNo"
	1    9300 4825
	0    1    1    0   
$EndComp
Wire Wire Line
...
F 4 "1N4148" H 9125 5625 50  0001 C CNN "PartNo"
	1    9125 5625
	0    1    1    0   
$EndComp
$Comp
...
F 1 "1u 50V" H 8590 1855 50  0000 L CNN
F 2 "" H 8513 1750 50  0001 C CNN
...
LED_D5
Text Label 4425 6725 2    50   ~ 0
LED_D6
Text Label 4425 6825 2    50   ~ 0
LED_D7
$Comp
L power:+3V3 #PWR011
U 1 1 5E8141F8
...
U 1 1 5E81637D
P 5425 6425
F 0 "#PWR09" H 5425 6175 50  0001 C CNN
F 1 "GND" H 5430 6252 50  0000 C CNN
F 2 "" H 5425 6425 50  0001 C CNN
...
U 1 1 5E81978D
P 5450 5625
F 0 "RV2" H 5381 5579 50  0000 R CNN
F 1 "R_POT" H 5381 5670 50  0000 R CNN
...
U 1 1 5E81EA05
P 5450 5775
F 0 "#PWR010" H 5450 5525 50  0001 C CNN
...
U 1 1 5E81FA6F
P 4825 7025
F 0 "#PWR08" H 4825 6775 50  0001 C CNN
...
F 1 "1u 50V" H 6065 5705 50  0000 L CNN
